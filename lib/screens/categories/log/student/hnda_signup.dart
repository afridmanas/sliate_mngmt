...
class hnda_signup extends StatefulWidget {
  @override
  State<hnda_signup> createState() => _hnda_signupState();
}

class _hnda_signupState extends State<hnda_signup> {
  String department = 'hnda';
